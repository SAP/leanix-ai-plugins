...
>
> **Note:** Prefer `activate_leanix_skill(skill_name="fact-sheet-search")` or `get_workspace_context(include_meta_model=True, fact_sheet_types=[...])` over `mcp__leanix__get_fact_sheet_types()` — the latter is deprecated and will be removed.
